...
export default function AdminCards({ admins }: AdminCardProps) {
  ...
  const handleShowLess = () => setVisibleCount((prev) => prev - 3);

  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-12">
      <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6 tracking-wide">
        {t("admins")}
      </h2>
          ...
          admin.email !== userEmail && (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-lg text-gray-500 dark:text-gray-300 break-all mt-1">
                  {admin.email}
                </p>
              </div>
            </div>
